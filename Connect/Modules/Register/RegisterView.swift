    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 30) {
            ...
            VStack(spacing: 12) {
                ...
                InfoTextField(placeHolder: "Password", enteredText: $viewModel.userData.password)
                InfoTextField(placeHolder: "Confirm Password", enteredText: $viewModel.userData.confirmPassword)
            }
            BlackButton {
